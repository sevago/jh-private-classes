...
class InvoiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoice entity")
        ...
        .repeat(2) {
            ...
            .post("/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "number":"0", "periodStartDate":"2020-01-01T00:00:00.000Z", "periodEndDate":"2020-01-01T00:00:00.000Z", "issueDate":"2020-01-01T00:00:00.000Z", "dueDate":"2020-01-01T00:00:00.000Z", "totalAmount":"0", "totalCurrency":null}""")).asJSON
            .check(status.is(201))
