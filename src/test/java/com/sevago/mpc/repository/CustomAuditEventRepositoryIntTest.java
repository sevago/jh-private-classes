...
import com.sevago.mpc.config.audit.AuditEventConverter;
import com.sevago.mpc.domain.PersistentAuditEvent;
...
import static com.sevago.mpc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
